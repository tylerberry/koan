...
@interface MUIMasterViewController () {
...
- (void)viewDidLoad
{
  ...
  self.detailViewController = (MUIDetailViewController *)[[self.splitViewController.viewControllers lastObject] topViewController];
}
