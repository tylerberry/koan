...
- (void) assertInteger: (NSInteger) actual equals: (NSInteger) expected message: (NSString *) message;
{
  [self assertTrue: (actual == expected) message: message];
}

- (void) assertUInteger: (NSUInteger) actual equals: (NSUInteger) expected
{
  [self assertTrue: (actual == expected)];
}

- (void) assertUInteger: (NSUInteger) actual equals: (NSUInteger) expected message: (NSString *) message
{
  [self assertTrue: (actual == expected) message: message];
}
